        ...
        <div class="classes-search-pannel">
            <center>
                <div class="box-align" style="width: 822px; margin-top: 10px;">
                    <input type="text" placeholder="Class Name" id="class_name" class="txtbox p">
                    ...
                    <select name="teacher" id="teacher" class="txtbox p">
                        ...
                        <option value="Saman Rathnayake">Saman Rathnayake</option>
    ...
    <div class="show-results" style="height: 87%;margin-top: 66px;">
        <table class="p" id="table">
            ...
            <tr>
                ...
                <td>600</td>
                <td>Sman Kumara</td>
                <td><button class="btn p btn-student" id="btn-student" onclick="show_class(1)">Student</button></td>
            </tr>
            <tr>
                <td>C01</td>
                <td>Grd7 Sinhala</td>
                ...
                <td>600</td>
                <td>Sman Kumara</td>
                <td><button class="btn p btn-student" id="btn-student" onclick="show_class(2)">Student</button></td>
            </tr>
            <tr>
                <td>C01</td>
                <td>Grd7 Sinhala</td>
