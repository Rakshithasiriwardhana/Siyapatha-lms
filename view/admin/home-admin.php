        ...
        <center>
            <div class="box-align" style="width: 1050px;">
                <section >
                    ...
                    <div style="height:331px;overflow: auto;width:546px;padding: 8px;" class="shadow">
                ...
                <section>
                    ...
                    <div style="background-color: white;width:456px;height:388px" class="shadow">
                        <div style="height: 193px;">
                            <p class="title2" style="float:left;margin-left:26px">Income</p><br>
                            <div><img src="../../images/icons/dollar.svg" style="width: 47px;margin-left: 91px;position: absolute;"></div><br>
                            <p class="rs">Rs.</p>
                            <p class="p income" id="show_income">17500.00</p>
                            <p class="p month" id="show_month">January</p>
                        </div>
                        <div style="background: linear-gradient(165.81deg, #423E9E -1.83%, #B345BB 111.42%);border-radius: 0px 0px 15px 15px;width:456px;height:195px">
                            <div class="squ">
                                <p class="p" style="float:left;margin-left: 34px;margin-top: 6px;margin-bottom: 7px;">Monthly Reports</p>
                                <select name="report" id="report" class="txtbox p">
                                    <option value="6">2020 December</option>
                                    <option value="7">January</option>
                                </select>
                                <button class="btn p btn-download" id="btn_download">Download</button>
                            </div>
                        </div>
                    </div>
